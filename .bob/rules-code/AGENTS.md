# Code Mode Rules - AI-Powered Observability Platform

This file contains coding-specific rules for AI assistants working in Code mode.
...
from app.utils import enforce_namespace
```
...
async def query_prometheus(
    ...
    """Query Prometheus with namespace filter"""
    pass
```

---

**Note**: Only include information discovered by reading actual code. Standard Python practices and framework defaults should NOT be documented here.